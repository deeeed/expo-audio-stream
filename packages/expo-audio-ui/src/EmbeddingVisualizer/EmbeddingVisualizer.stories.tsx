...
import { EmbeddingVisualizer, EmbeddingVisualizerProps } from './EmbeddingVisualizer';

// Mock embeddings data for demonstration
const generateMockEmbeddings = (numEmbeddings: number, embeddingLength: number): number[][] => {
