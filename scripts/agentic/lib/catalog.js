...
function getTeamsDir(explicitAppRoot) {
  return path.join(getAppRoot(explicitAppRoot), 'scripts', 'agentic', 'teams');
}

function loadAgenticConfig(explicitAppRoot) {
  const appRoot = getAppRoot(explicitAppRoot);
  const confPath = path.join(appRoot, 'scripts', 'agentic', 'agentic.conf');
