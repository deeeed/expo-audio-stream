...
export const DEFAULT_MAX_ACTIVE_PATHS = 4
export const DEFAULT_TOP_K = 5
export const DEFAULT_LIVE_SAMPLE_RATE = 16000
export const DEFAULT_VAD_WINDOW_SIZE = 512
export const MODEL_STATES_STORAGE_KEY = '@model_states'
...
export const DEFAULT_WEB_AUDIO_TAGGING_MODEL_ID =
    WEB_FEATURES.audioTagging.modelId
...
export const WEB_MODEL_FEATURE_MAP: Record<string, WebFeatureKey> =
    Object.fromEntries(
        Object.entries(WEB_FEATURES).map(([key, entry]) => [
            entry.modelId,
            key as WebFeatureKey,
        ])
