# Sherpa Voice — Store Listings

## Short Description (< 80 chars)

Explore on-device speech AI — recognition, TTS, and more. Offline, open source.

(79 chars)


## Full Description (< 4000 chars) — Google Play / Apple App Store
...
Try 10 on-device speech and audio AI features — speech recognition, TTS, speaker ID, and more. Fully offline, open source. Built for developers exploring mobile AI.
...
speech recognition,tts,offline,ai,voice,onnx,sherpa,audio,speaker,react native
