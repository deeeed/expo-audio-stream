...
import type { AlgorithmResult, BatchProcessingResults, TonnetzResult } from '@siteed/react-native-essentia'
...
import type { AssetSourceType, SampleAudioFile } from '../hooks/useSampleAudio'
  ...
  const validateEssentiaIntegration = async () => {
    ...
    try {
      ...
      try {
        ...
        if (mfccResult && (mfccResult.mfcc || (mfccResult.data?.mfcc))) {
